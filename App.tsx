...
const SUBJECTS = ["Toán"]; // Restricted to Math only
...
const App: React.FC = () => {
  ...
  // Initial plans adjusted for 3 levels (NB, TH, VD)
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `Math_Exam_G${config.grade}_${Date.now()}.${extension}`;
            ...
            <div className="p-5 grid grid-cols-2 gap-5">
               <div className="col-span-1">
                  ...
                  <select 
                    ...
                    disabled
                    className="w-full bg-slate-100 border border-slate-300 rounded-lg px-3 py-2.5 text-sm cursor-not-allowed text-slate-500"
                  >
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-[500px]">
             <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-gradient-to-r from-white to-primary-50">
                ...
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    {isSuggesting ? 'Đang suy nghĩ...' : 'Gợi ý chủ đề'}
                  </button>
                  <button 
                    onClick={addPlanRow}
             ...
             <div className="flex-1 overflow-y-auto custom-scroll p-4">
                ...
                <div className="grid grid-cols-12 gap-3 text-[11px] font-bold text-slate-400 mb-3 px-2 uppercase tracking-wider">
                   <div className="col-span-5">Chủ đề Toán học</div>
          ...
          >
             {isGenerating ? (
               <div className="flex items-center justify-center">
                 ...
                 <span>Đang tạo đề thi Toán...</span>
               </div>
             ) : (
               <div className="flex items-center justify-center">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
             <h3 className="text-xs font-bold text-slate-500 uppercase mb-3 flex items-center">
                <i className="fa-solid fa-chart-pie mr-2 text-primary-500"></i>Phân bổ mức độ (NB-TH-VD)
             </h3>
